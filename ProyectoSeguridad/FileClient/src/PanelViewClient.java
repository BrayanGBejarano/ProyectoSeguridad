...
public class PanelViewClient extends JPanel implements ActionListener {
    ...
    private MainViewClient mainViewClient;

    public PanelViewClient(MainViewClient mainViewClient) {

        this.mainViewClient = mainViewClient;

        setLayout(null);
        setBackground(Color.WHITE);

        lb_ipserver = new JLabel("IP Server:");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals(SELECT_FILE)) {
            mainViewClient.selectFile();
        } else if (command.equals(ACCEPT)){
            mainViewClient.accept();
    ...
    public MainViewClient getMainViewClient() {
        return mainViewClient;
    }

    public void setMainViewClient(MainViewClient mainViewClient) {
        this.mainViewClient = mainViewClient;
    }
}
